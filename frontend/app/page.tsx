...
export default function Home() {
  return (
    <div className="container">
      ...
      <p>
        📷 <em>Nhập liệu, tìm kiếm đối tượng quản lý:</em>
      </p>

      <Img src="/assets/inputEntity.png" alt="Input entity" />
      ...
      <p>
        📷 <em>(Trường hợp nâng cao) Tạo thêm trang quản lý:</em>
      </p>

      <Img src="/assets/customView.png" alt="Custom view" />

      <p>
        📷 <em>(Trường hợp nâng cao) Tạo thêm trang quản lý Với AI:</em>
      </p>

      <Img src="/assets/generateViewWithAi.png" alt="Generate view with AI" />
