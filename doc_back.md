...
<url image entityConfigOverview.png>
...
<url video createTeamMemberEntity.mov>
...
📹 Tạo - nhập liệu, tìm kiếm với kiểu enum: <url demoEnumField>
...
📹 Ví dụ đề xuất: <url demoArrayReference>
...
📹 Tạo field address: <url demoEmbeddedDocument>

---

## **7.5 Array Embedded Documents – Lịch sử công việc**

📹 Ví dụ đề xuất: <url embedded_array_example>
...
📹 Custom validation: <url customValidation>
📹 Custom computation: <url customComputation>
